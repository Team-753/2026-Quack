...
offsetList=[0.7083120783296617,0.3599781216554734,0.13246701675334055,0.5696525556151847] ##ONLY APPLIES IF USEING WPI ENCODERS(NOT CANCODER)
##quack 0.7083120783296617,0.3599781216554734,0.13246701675334055,0.5696525556151847##
##WIWO 0.7083120783296617,0.3599781216554734,0.13246701675334055,0.5696525556151847## TESTBOT-0.396728515625,0.071533203125,0.16455078125,0.45654296875
swerveEncoderType="wpilibEncoder" #canCoder,wpilibEncoder #IF NOT USING AN ENCODER LEAVE swerveEncoderIds BLANK
robotCompassType="navx" #navx,pidgeon #NOTE navx not working, need to get inport working
robotCompassId=13 #FOR PIDGEON ONLY

#SWERVE CAN IDS
swerveDriveIds=[1,3,5,7]#4,7,10,1]   #1,4,7,10]
swerveTurnIds=[2,4,6,8]#6,9,12,3]  # 3,6,9,12]
swerveEncoderIds=[0,1,2,3]#5,8,0,2]#2,5,8,0] #EXTERNAL ENCODERS, NOT MOTORS
...
swerveTurnRatio=(12.8)  #NECECCARY IF NOT USING A CANCODER #quack 12.8
